...
cached_points = model.cached_points;
cached_fvalues = model.cached_fvalues;
...
if newindex <= dimension + 1
    ...
    % Removing substituted point
    points_scaled(:, basis_size+1:end) = [];
    fvalues(:, basis_size+1:end) = [];
    points_abs(:, basis_size+1:end) = [];
end
...
model.cached_points = cached_points;
model.cached_fvalues = cached_fvalues;

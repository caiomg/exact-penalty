...
%   
    ...
    n_cons_total = size(R, 2);
    n_cons_not_bounds = n_cons_total - n_bounds_active;

    initial_estimate = zeros(n_cons_total, 1);
    [initial_estimate, tol] = l1_estimate_multipliers_no_bounds(p_grad, ...
                                                      Q, R);
    dim = size(p_grad, 1);
    H = R'*R;
    g = (R'*Q'*p_grad);
    ...
    [all_multipliers, ~, exitflag, ~, fmincon_lambda] = ...
        fmincon(f, initial_estimate, [], [], [], [], bl_mult, [], [], fmincon_options);

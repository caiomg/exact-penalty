function result = handle_problem(problem_data, solver_configuration)
% HANDLE_PROBLEM - 
%   
...
%%
    ...
    l1_options.first_feasible_only = true;
    try
        p_seed = rng('default');

        [x, hs2, ff] = l1_penalty_solve(f, all_con, con_lb, con_ub, x0, ...
    ...
    result = struct('name', problem_name, ...
                    'x', ff.x, ...
                    'fx', ff.fx, ...
                    'viol', ff.viol, ...
